...
const schemas = {
  ...
  "boundary-condition": "schemas/boundary-condition/v1.schema.json",
  "coordinate-system": "schemas/coordinate-system/v1.schema.json",
  "domain-pack": "schemas/domain-pack/v1.schema.json",
  "effective-parent-audit": "schemas/effective-parent-audit/v1.schema.json",
  failure: "schemas/evidence/failure-v1.schema.json",
  "field-component": "schemas/field-component/v1.schema.json",
  "field-observation": "schemas/field-observation/v1.schema.json",
  "field-point": "schemas/local-brot/v1.schema.json",
  "field-table": "schemas/field-table/v1.schema.json",
  "geometric-scale-registry": "schemas/geometric-scale-registry/v1.schema.json",
  "geometry-aware-null-registry": "schemas/geometry-aware-null-registry/v1.schema.json",
  "geometry-claim-adjudication": "schemas/geometry-claim-adjudication/v1.schema.json",
  "geometry-indexed-domain-pack": "schemas/geometry-indexed-domain-pack/v1.schema.json",
  "geometry-operator-registry": "schemas/geometry-operator-registry/v1.schema.json",
  "geometry-perturbation-registry": "schemas/geometry-perturbation-registry/v1.schema.json",
  "geometry-tbx-profile": "schemas/geometry-tbx-profile/v1.schema.json",
  "mask-contract": "schemas/mask-contract/v1.schema.json",
  "nested-replicate-registry": "schemas/nested-replicate-registry/v1.schema.json",
  "operation-depth-registry": "schemas/operation-depth-registry/v1.schema.json",
  "parent-registry": "schemas/parent-registry/v1.schema.json",
  "projection-registry": "schemas/projection-registry/v1.schema.json",
  "representation-agreement": "schemas/representation-agreement/v1.schema.json",
  "run-spec": "schemas/run-spec/v1.schema.json",
  "scout-eligibility": "schemas/scout-eligibility/v1.schema.json",
  "structure-channel-registry": "schemas/structure-channel-registry/v1.schema.json",
